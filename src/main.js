...
//   renderer.setClearColor("green"); // Background color
...
//     45, // Field of View / Focus range angle
...
function animate() {
  ...
  cubes.forEach(function (c) {
    ...
    // c.position.x += Math.random() / 10;
    // c.position.y += Math.random() / 10;
    // c.position.z += Math.random() / 10;
  });
